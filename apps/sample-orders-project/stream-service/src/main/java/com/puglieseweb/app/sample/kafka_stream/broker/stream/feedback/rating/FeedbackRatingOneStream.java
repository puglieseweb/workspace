...
import com.puglieseweb.app.sample.kafka_stream.broker.message.FeedbackRatingOneMessage;
...
public class FeedbackRatingOneStream {
	...
	public KStream<String, FeedbackMessage> kstreamFeedbackRating(StreamsBuilder builder) {
		...
		feedbackStream
				.transformValues(() -> new FeedbackRatingOneTransformer(feedbackRatingStateStoreName),
