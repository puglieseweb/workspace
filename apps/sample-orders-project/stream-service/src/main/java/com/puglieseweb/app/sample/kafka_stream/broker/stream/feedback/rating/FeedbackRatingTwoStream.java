...
import com.puglieseweb.app.sample.kafka_stream.broker.message.FeedbackRatingTwoMessage;
...
public class FeedbackRatingTwoStream {
	...
	public KStream<String, FeedbackMessage> kstreamFeedbackRating(StreamsBuilder builder) {
		...
		feedbackStream
				.transformValues(() -> new FeedbackRatingTwoTransformer(feedbackRatingStateStoreName),
